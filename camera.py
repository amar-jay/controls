...
waypoints = [
    (lat + 0.00001, lon + 0.0001, alt+10),
    (lat, lon, alt+10),
    (lat + 0.00001, lon - 0.00001, alt+10),
    (lat, lon, alt+10),
    (lat - 0.00001, lon - 0.00001, alt+10),
    (lat, lon, alt+10),
    (lat - 0.00001, lon + 0.00001, alt+10),
...
for idx, (lat, lon, alt) in enumerate(waypoints):
    ...
    while True:
        ...
        coords, center_pose, annotated_frame = estimator.process_frame(frame, current_lat, current_lon, alt, object_class="helipad")
