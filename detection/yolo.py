...
class YoloObjectTracker:
    ...
    def process_frame(self, detections, current_lat, current_lon, altitude, object_class="helipad"):
        ...
        target_gps = self.meters_to_gps(
            current_lat, current_lon, offset_x, offset_y
        )
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            ...
            coords, center_pose, annotated_frame = w #TODO: add these parameters to frame -> return (target_lat, target_lon), (cx, cy), annotated_frame
            if coords is None or center_pose is None:
                cv2.putText(annotated_frame, "No target detected", (10, 30), cv2.FONT_HERSHEY_SIMPLEX,
            ...
            cv2.putText(annotated_frame, text_latlon, (10, 30), cv2.FONT_HERSHEY_SIMPLEX,
                        0.7, (0, 255, 0), 2, cv2.LINE_AA)
            cv2.putText(annotated_frame, text_center, (10, 60), cv2.FONT_HERSHEY_SIMPLEX,
                    0.7, (0, 255, 0), 2, cv2.LINE_AA)
