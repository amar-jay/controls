...
def compute_target_gps(drone_gps, drone_altitude, elevation_angle_deg, azimuth_angle_deg):
    """
    ...
    if elevation_rad >= 0:
        raise ValueError("For ground targets the elevation angle should be negative (target below horizontal).")
